...
const Specialization = () => {
  return (
    <section id="specializations" className="py-20 bg-bg-dark">
      <div className="max-w-[1280px] mx-auto px-5">
        
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-16 gap-5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-bg-tert p-10 pt-10 px-8 rounded relative overflow-hidden flex flex-col min-h-[380px] group">
          ...
          <div className="bg-primary p-10 pt-10 px-8 rounded relative overflow-hidden flex flex-col min-h-[380px] group">
