    ...
    return (
        <div className="min-h-screen bg-bg-dark flex items-center justify-center px-5">
            <div className="bg-bg-sec p-10 rounded-lg shadow-2xl w-full max-w-md border border-white/5">
                <h2 className="text-4xl italic font-heading mb-8 text-center">ADMIN <span className="text-primary">LOGIN</span></h2>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-2">
                        <label className="text-[10px] font-bold tracking-[1px] text-text-sec">PASSWORD</label>
                        <input 
                            type="password" 
                            name="password"
                            placeholder="••••••••" 
