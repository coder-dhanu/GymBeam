...
const Membership = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await setDoc(doc(db, 'settings', 'membership'), formData);
      setMessage({ type: 'success', text: 'Membership info saved successfully!' });
  ...
  return (
    <AdminLayout>
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-white tracking-tight mb-2 uppercase">Membership Settings</h1>
        <p className="text-white/40 text-sm max-w-2xl leading-relaxed">
          Customize the membership page header and introductory content.
        </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 max-w-4xl">
        ...
        <div className="bg-[#111111] p-8 rounded-2xl border border-white/5 space-y-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold text-white">Header Content</h2>
          </div>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold text-white/30 uppercase tracking-widest">Introductory Description</label>
            <textarea 
