...
const About = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    aboutHeadline: "The Beam of Human Potentialpk",
    aboutParagraph:
    ...
    missionDescription:
      "Our mission is to provide a unique atmosphere to enhance movement development through health and fitness for toddlers, children, teens and families for a promotion life long wellness.",
  });
    ...
    <AdminLayout>
      <div className="mb-10">
        ...
        <p className="text-white/40 text-sm max-w-2xl leading-relaxed">
          Manage your gym's brand story, structural philosophy, vision, and
          mission.
        </p>
