...
const Gallery = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await setDoc(doc(db, 'settings', 'gallery'), formData);
      setMessage({ type: 'success', text: 'Gallery info saved successfully!' });
  ...
  return (
    <AdminLayout>
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-white tracking-tight mb-2 uppercase">Gallery Settings</h1>
        <p className="text-white/40 text-sm max-w-2xl leading-relaxed">
          Manage the introductory content for your gym's visual showcase.
        </p>
