...
const Services = () => {
  ...
  return (
    <AdminLayout>
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-white tracking-tight mb-2 uppercase">Service Settings</h1>
        <p className="text-white/40 text-sm max-w-2xl leading-relaxed">
          Manage the introductory content for your gym's services and amenities.
        </p>
